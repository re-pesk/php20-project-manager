...
export default [
    ...
    { exact: true, path: '/project/create', content: CreateProject, title: 'Create Project', accessibility: accessType.requiresLogin },
    { exact: true, path: '/project/edit', content: UpdateProject, title: 'Update Project', accessibility: accessType.requiresLogin },
    { exact: true, path: '/project/tasks', content: ProjectTasks, title: 'Project Tasks', accessibility: accessType.requiresLogin },
    { exact: true, path: '/project/task/create', content: CreateTask, title: 'Edit task', accessibility: accessType.requiresLogin },
    { exact: true, path: '/project/task/edit', content: EditTask, title: 'Edit task', accessibility: accessType.requiresLogin },
